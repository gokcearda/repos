...
namespace SqlForm {
    ...
    public partial class dbPersonelDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonelDataTable : global::System.Data.TypedTableBase<PersonelRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonelRow AddPersonelRow(int Id, string AdSoyad, int Yas, string Telefon, string Cinsiyet) {
        ...
        public partial class PersonelRow : global::System.Data.DataRow {
            ...
            public int Yas {
                get {
                    try {
                        return ((int)(this[this.tablePersonel.YasColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("\'Personel\' tablosundaki \'Yas\' sütunun değeri DBNull.", e);
                    }
                }
                set {
...
namespace SqlForm.dbPersonelDataSetTableAdapters {
    ...
    public partial class PersonelTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Personel] WHERE (([Id] = @Original_Id) AND ((@IsNull_AdSoyad = 1 AND [AdSoyad] IS NULL) OR ([AdSoyad] = @Original_AdSoyad)) AND ((@IsNull_Yas = 1 AND [Yas] IS NULL) OR ([Yas] = @Original_Yas)) AND ((@IsNull_Telefon = 1 AND [Telefon] IS NULL) OR ([Telefon] = @Original_Telefon)) AND ((@IsNull_Cinsiyet = 1 AND [Cinsiyet] IS NULL) OR ([Cinsiyet] = @Original_Cinsiyet)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Personel] ([Id], [AdSoyad], [Yas], [Telefon], [Cinsiyet]) VALU" +
                "ES (@Id, @AdSoyad, @Yas, @Telefon, @Cinsiyet);\r\nSELECT Id, AdSoyad, Yas, Telefon" +
                ", Cinsiyet FROM Personel WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Personel] SET [Id] = @Id, [AdSoyad] = @AdSoyad, [Yas] = @Yas, [Telefon] = @Telefon, [Cinsiyet] = @Cinsiyet WHERE (([Id] = @Original_Id) AND ((@IsNull_AdSoyad = 1 AND [AdSoyad] IS NULL) OR ([AdSoyad] = @Original_AdSoyad)) AND ((@IsNull_Yas = 1 AND [Yas] IS NULL) OR ([Yas] = @Original_Yas)) AND ((@IsNull_Telefon = 1 AND [Telefon] IS NULL) OR ([Telefon] = @Original_Telefon)) AND ((@IsNull_Cinsiyet = 1 AND [Cinsiyet] IS NULL) OR ([Cinsiyet] = @Original_Cinsiyet)));
SELECT Id, AdSoyad, Yas, Telefon, Cinsiyet FROM Personel WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SqlForm.Properties.Settings.Default.dbPersonelConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, AdSoyad, Yas, Telefon, Cinsiyet FROM dbo.Personel";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, AdSoyad, Yas, Telefon, Cinsiyet FROM dbo.Personel";
        ...
        public virtual int Fill(dbPersonelDataSet.PersonelDataTable dataTable) {
        ...
        public virtual dbPersonelDataSet.PersonelDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbPersonelDataSet.PersonelDataTable dataTable = new dbPersonelDataSet.PersonelDataTable();
        ...
        public virtual int FillBy(dbPersonelDataSet.PersonelDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbPersonelDataSet.PersonelDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_AdSoyad, global::System.Nullable<int> Original_Yas, string Original_Telefon, string Original_Cinsiyet) {
        ...
        public virtual int Insert(int Id, string AdSoyad, global::System.Nullable<int> Yas, string Telefon, string Cinsiyet) {
        ...
        public virtual int Update(int Id, string AdSoyad, global::System.Nullable<int> Yas, string Telefon, string Cinsiyet, int Original_Id, string Original_AdSoyad, global::System.Nullable<int> Original_Yas, string Original_Telefon, string Original_Cinsiyet) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string AdSoyad, global::System.Nullable<int> Yas, string Telefon, string Cinsiyet, int Original_Id, string Original_AdSoyad, global::System.Nullable<int> Original_Yas, string Original_Telefon, string Original_Cinsiyet) {
            return this.Update(Original_Id, AdSoyad, Yas, Telefon, Cinsiyet, Original_Id, Original_AdSoyad, Original_Yas, Original_Telefon, Original_Cinsiyet);
        }
    }
